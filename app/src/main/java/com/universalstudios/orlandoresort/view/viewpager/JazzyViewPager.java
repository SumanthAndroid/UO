package com.universalstudios.orlandoresort.view.viewpager;
...
public class JazzyViewPager extends ViewPager {
	private static final String TAG =  JazzyViewPager.class.getSimpleName();
	...
	private final HashMap<Integer, Object> mObjs = new LinkedHashMap<Integer, Object>();
	private static final SparseArray<TransitionEffect> mTransitionEffects;
	...
	static {
		mTransitionEffects = new SparseArray<TransitionEffect>();
		for(TransitionEffect transitionEffect : TransitionEffect.values()) {
			mTransitionEffects.put(transitionEffect.ordinal(), transitionEffect);
		}
	}
	...
	public JazzyViewPager(Context context, AttributeSet attrs) {
		...
		setTransitionEffect(mTransitionEffects.get(effect));
	...
	private void logState(View v, String title) {
		if (BuildConfig.DEBUG) {
			/*
			Log.d(TAG, title + ": ROT (" + ViewHelper.getRotation(v) + ", " +
	...
	public void setObjectForPosition(Integer position, Object obj) {
		mObjs.put(position, obj);
	}

	public void removeObjectForPosition(Integer position) {
