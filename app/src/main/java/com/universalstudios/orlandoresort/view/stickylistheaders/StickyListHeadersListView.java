package com.universalstudios.orlandoresort.view.stickylistheaders;
...
import com.universalstudios.orlandoresort.view.stickylistheaders.WrapperViewList.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
	...
	public int getScrollPosY(){
		...
		if(c != null) {
			return -c.getTop() + mList.getFirstVisiblePosition() * c.getHeight();
		} else {
			return 0;
		}
	}
