...
public class HttpResponseStatus {
	...
	public static final int ERROR_CONNECTION_CLOSED = 444;
	public static final int ERROR_ACCOUNT_REGISTERED = 445;
	public static final int SUCCESS_NO_ENTITLEMENT_EXISTS = 244;
