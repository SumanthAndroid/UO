...
/**
 * {@link AccountUpdateContactInfoActivity} which will initiate the {@link AccountUpdateContactInfoFragment}.
 *
 * Created by Tyler Ritchie on 11/17/16.
 */

public class AccountUpdateContactInfoActivity extends NetworkRefreshActivity implements AccountUpdateProvider {

    private static final String TAG = AccountUpdateContactInfoActivity.class.getSimpleName();
    private static final String KEY_ARG_GUEST_PROFILE = "KEY_ARG_GUEST_PROFILE";

    /**
     * Create a bundle to pass to {@link AccountUpdateContactInfoActivity}.
     *
    ...
    public static Intent newInstanceIntent(Context context, GuestProfile guestProfile) {
        ...
        Intent intent = new Intent(context, AccountUpdateContactInfoActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_update_contact_info);
        ...
        if (savedInstanceState == null) {
            ViewGroup fragmentContainer = (ViewGroup) findViewById(R.id.account_update_contact_info_container);
            if (fragmentContainer != null) {
                AccountUpdateContactInfoFragment fragment =
                        AccountUpdateContactInfoFragment.newInstance(guestProfile);
        ...
        setActionbarTitle(tridionConfig.getContactInformationTitle());
    }
