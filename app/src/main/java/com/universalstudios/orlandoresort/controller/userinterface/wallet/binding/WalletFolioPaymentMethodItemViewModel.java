 ...
 * @author acampbell
 */
public class WalletFolioPaymentMethodItemViewModel extends BaseObservableWithLayoutItem {
    ...
    public WalletFolioPaymentMethodItemViewModel(@NonNull WalletFolioCard card) {
        setWalletFolioCard(card);
    }

    @Override
    public int getLayoutId() {
        return R.layout.item_wallet_folio_credit_card;
    }
